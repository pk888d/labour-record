...
// DNV has exactly 6 seeded employees and no other spec leaves extras behind by
// the time this file runs, so the fixture cycle snapshots exactly 6 — required
// for the "exactly 2 .form-page" assertions below.
const DNV_ESTABLISHMENT_ID = 'est_hospital_dnv'
const CYCLE_YEAR = 2086
const CYCLE_MONTH = 6
